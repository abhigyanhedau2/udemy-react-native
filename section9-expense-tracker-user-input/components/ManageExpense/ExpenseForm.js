...
export default function ExpenseForm(props) {
    ...
    return <View>
        ...
        <View style={styles.inputsRow}>
            <Input label="Amount" style={styles.flex1} invalid={!inputs.amount.isValid} textInputConfig={{
                placeholder: "$0.00",
                inputMode: "decimal",
                onChangeText: inputChangedHandler.bind(null, "amount"),
                value: inputs.amount.value
            }} />
            <Input label="Date" style={styles.flex1} invalid={!inputs.date.isValid} textInputConfig={{
        ...
        {!(inputs.amount.isValid && inputs.date.isValid && inputs.description.isValid) &&
            <Text style={styles.errorText}>Invalid Form Inputs</Text>}
